...
MODULE_DESCRIPTION("Non Contiguous Memory Mapping");
...
static int __init my_init(void)
{
	...
	ret = register_chrdev_region(MKDEV(MY_MAJOR, 0), 1, "mymmap");
	if (ret < 0)
	{
	...
	for (i = 0; i < NPAGES * PAGE_SIZE; i += PAGE_SIZE)
	{
		// Write Hello World in each page
